            ...
            <div class="card shadow mb-12">
                ...
                <div class="card-body">
                    <a href="{{ route('post.create') }}"
                        class="btn btn-outline-primary btn-sm">{{ __create('translate.') }}</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card shadow mb-12">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-outline-primary btn-sm"
                            href="{{ route('post.edit',$post->id) }}">{{ __('translate.edit_post') }}</a>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">
                                            {{ __('translate.delete_warning') }}</h5>
                                    ...
                                    <div class="modal-footer">
                                        <form method="POST" action="{{ route('post.destroy',$post->id) }}">
                                            ...
                                            <form action="{{ route('user.destroy',$user->id )}}" method="POST">
                                                ...
                                                @csrf
                                                <button type="submit"
                                                    class="btn btn-primary">{{ __('translate.delete') }}</button>
                                            </form>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="collapse show" id="collapseCardExample">
                                <div class="card-body">
                                    ...
                                    <button class="btn btn-outline-primary btn-sm" type="submit" data-toggle="modal"
                                        data-target="#logoutModal1">{{ __('translate.delete_comment') }}</button>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    {{ __('translate.delete_warning_text_comment') }}</div>
                                                <div class="modal-footer">
                                                    <form method="POST"
                                    ...
                                    <form class="col-8" action="{{ route('commentStore',$post->id) }}" method="POST">
                                        ...
                                        <button type="submit"
                                            class="btn btn-primary">{{ __('translate.share') }}</button>
                                    </form>
                                </div>
                            </div>
                        </div>
